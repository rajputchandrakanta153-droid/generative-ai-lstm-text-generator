...
#         text = f.read().lower()
#     # Remove unwanted characters, keep letters, numbers, punctuation, and whitespace
#     text = re.sub(r'[^a-z0-9\s.,!?;:\'\n]', '', text)
#     return text

# if not os.path.exists("shakespeare.txt"):
#     raise FileNotFoundError("shakespeare.txt not found! Put it in the same folder as this script.")
...
#             input_seq = [0] * (SEQ_LENGTH - len(input_seq)) + input_seq  # pad with zeros
...
# print("\n--- Generated Text ---\n")
# print(generate_text(seed, length=500, temperature=0.8))
